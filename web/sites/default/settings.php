...
// Local settings override, symlink i.e. local.settings.php -> overrides
if (file_exists(dirname(__FILE__) . '/settings.overrides.php')) {
  include dirname(__FILE__) . '/settings.overrides.php';
}

// <DDSETTINGS>
// Please don't edit anything between <DDSETTINGS> tags.
// This section is autogenerated by Acquia Dev Desktop.
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal7_demo_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal7_demo_dd.inc';
}
// </DDSETTINGS>
